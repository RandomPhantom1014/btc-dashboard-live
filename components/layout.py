...
def create_layout():
    return dbc.Container(
        [
            ...
            dbc.Row([
                dbc.Col([
                    html.Div("📈 Short-Term Signals", className="timeframe-header"),
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-5m", className="timestamp"),
                        html.Div(id="countdown-5m", className="countdown")
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-10m", className="timestamp"),
                        html.Div(id="countdown-10m", className="countdown")
                    ], className="signal-row"),
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-15m", className="timestamp"),
                        html.Div(id="countdown-15m", className="countdown")
                    ], className="signal-row")
                ], md=6),

                dbc.Col([
                    html.Div("📊 Long-Term Signals", className="timeframe-header"),
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-1h", className="timestamp"),
                        html.Div(id="countdown-1h", className="countdown")
                    ], className="signal-row"),
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-6h", className="timestamp"),
                        html.Div(id="countdown-6h", className="countdown")
                    ], className="signal-row"),
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-12h", className="timestamp"),
                        html.Div(id="countdown-12h", className="countdown")
                    ], className="signal-row"),
                    ...
                    html.Div([
                        ...
                        html.Div(id="timestamp-24h", className="timestamp"),
                        html.Div(id="countdown-24h", className="countdown")
                    ], className="signal-row")
                ], md=6),
            ]),
